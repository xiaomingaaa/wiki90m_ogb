python train.py --model_name TransE_l2 --hidden_dim 128 --gamma 10 --lr 0.1 --regularization_coef 1e-9 --valid --test -adv --mix_cpu_gpu --num_proc 3 --num_thread 4 --gpu 1 2 3 --async_update --force_sync_interval 10000 --no_save_emb --print_on_screen --encoder_model_name roberta --save_path save_path
...
python train.py --model_name TransE_l2 --hidden_dim 256 --gamma 10 --lr 0.1 --regularization_coef 1e-9 --valid --test -adv --mix_cpu_gpu --num_proc 4 --num_thread 4 --gpu 0 1 2 3 --async_update --force_sync_interval 10000 --no_save_emb --print_on_screen --encoder_model_name shallow --save_path save_path

python train.py --model_name RoatE --hidden_dim 100 --gamma 10 --lr 0.1 --regularization_coef 1e-9 --valid --test -adv --mix_cpu_gpu --num_proc 4 --num_thread 4 --gpu 0 1 2 3 --double_ent --async_update --force_sync_interval 10000 --no_save_emb --print_on_screen --encoder_model_name shallow --save_path save_path
...
###
 ...
 # @LastEditTime: 2021-05-20 03:37:39
...
python save_test_submission.py save_path/TransE_l2_wikikg90m_roberta_d_200_g_10.02  3
# TransE-shallow
